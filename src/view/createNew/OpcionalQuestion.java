 ...
 * @author fabmont
 */
public class OpcionalQuestion extends javax.swing.JFrame {

    /**
     * Creates new form OpcionalQuestion
     */
    public OpcionalQuestion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpcionalQuestion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OpcionalQuestion().setVisible(true);
            }
        });
    }
